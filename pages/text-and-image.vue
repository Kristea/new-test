<template>
    <div>
        ...
        <h2>Standard text left image right (no props) - should image have max-height when not full?? Or should it have to match height of text??</h2>
        <KTextLeftImgRight />

        <h2>Full image, image left, text right</h2>
